      ...
      <div className="container-fluid bg-white sticky-top wow fadeIn" data-wow-delay="0.1s">
        <div className="container">
          <nav className="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
            <NavLink href="index.html" className="navbar-brand d-lg-none">
              ...
              <div className="navbar-nav">
                ...
                <div className="nav-item dropdown">
                  ...
                  <div className="dropdown-menu bg-light rounded-0 rounded-bottom m-0">
                    <NavLink to='/sadd' className="dropdown-item">Service Add</NavLink>
                    <NavLink to='/smanage' className="dropdown-item">Service Manage</NavLink>
                  </div>
                </div>
                <div className="nav-item dropdown">
                  <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                  <div className="dropdown-menu bg-light rounded-0 rounded-bottom m-0">
                    <NavLink to="/feauters" className="dropdown-item">Features</NavLink>
                    <NavLink to="/team" className="dropdown-item">Our Team</NavLink>
                    <NavLink to="/test" className="dropdown-item">Testimonial</NavLink>
                    <NavLink to="/appoint" className="dropdown-item">Appoinment</NavLink>
                ...
                {(()=>{
                  if(localStorage.getItem("Adminid")){
                    return(
                       <li className="nav-item nav-link active"><Link>{localStorage.getItem("Adminname")}</Link></li>
                    )
                  }
                })()}
                ...
                {(() => {
                  if (localStorage.getItem("Adminid")) {
                    return (
                      <li className="nav-item nav-link active"><Link onClick={logout}>Log Out</Link></li>
                    )
                  }
                  else {
                    return (
