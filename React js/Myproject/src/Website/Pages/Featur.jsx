  ...
  <div className="container">
    ...
    <div className="row g-5 align-items-center text-center">
      <div className="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
        <i className="fa fa-calendar-alt fa-5x text-primary mb-4" />
      ...
      <div className="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
        <i className="fa fa-tasks fa-5x text-primary mb-4" />
        <h4>Best Interior Design</h4>
        <p className="mb-0">Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo
          justo et tempor eirmod magna dolore erat amet</p>
      </div>
      <div className="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
        <i className="fa fa-pencil-ruler fa-5x text-primary mb-4" />
        <h4>Innovative Architects</h4>
        <p className="mb-0">Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo
          justo et tempor eirmod magna dolore erat amet</p>
      </div>
      <div className="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
        <i className="fa fa-user fa-5x text-primary mb-4" />
        <h4>Customer Satisfaction</h4>
        <p className="mb-0">Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo
          justo et tempor eirmod magna dolore erat amet</p>
      </div>
      <div className="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
        <i className="fa fa-hand-holding-usd fa-5x text-primary mb-4" />
        <h4>Budget Friendly</h4>
        <p className="mb-0">Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo
          justo et tempor eirmod magna dolore erat amet</p>
      </div>
      <div className="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
        <i className="fa fa-check fa-5x text-primary mb-4" />
