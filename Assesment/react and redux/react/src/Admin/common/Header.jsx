                ...
                <div className="container-fluid bg-secondary top-bar wow fadeIn" data-wow-delay="0.1s">
                    <div className="row align-items-center h-100">
                        <div className="col-lg-4 text-center text-lg-start">
                            <NavLink to="/dash">
                                <h1 className="display-5 text-primary m-0">Admin</h1>
                            </NavLink>
                        </div>
                        ...
                        <nav className="navbar navbar-expand-lg bg-primary navbar-dark px-4 py-lg-0">
                            ...
                            <div className="collapse navbar-collapse" id="navbarCollapse">
                                <div className="navbar-nav me-auto">
                                    ...
                                    <NavLink to="/pro" className="nav-item nav-link">Product</NavLink>
                                ...
                                <div className='d-flex text-white'>
                                    {
                                        (() => {
                                            if (localStorage.getItem('Aid')) {
                                                return (
                                                    <button className="nav-item nav-link btn btn-dark mx-2">{localStorage.getItem("Aname")}</button>
                                                )
                                            }
                                        })()
                                    }
                                    {
                                        (()=>{
                                            if(localStorage.getItem('Aid')){
                                                return(
                                                    <button onClick={logout} className="nav-item btn btn-dark nav-link">logout</button>
                                                )
                                            }
                                            else{
                                                return(
